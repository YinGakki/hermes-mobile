...
## [v0.0.2-beta] — 2026-07-08

测试版。在 v0.0.2 基础上增加测试版标识机制和 SHA256 更新检测。
...
- **SHA256 更新检测** — CI 在 Release body 中写入 APK 的 SHA256 校验值，应用检测更新时优先比较本地 APK 和 Release APK 的 SHA256，解决版本号不变但内容更新的检测问题
...
- **WebUI/Hermes 更新不再跳转安装页** — 修复更新 WebUI/Hermes Agent 时被强制切换到安装界面的问题：tryAcquireInstallLock 新增 switchToInstallPage 参数，在线更新场景传 false，仅显示进度弹窗，不切换页面
- **更新后版本号颜色恢复** — 修复更新完成后版本号文字仍为绿色（让人误以为还有更新）的问题：checkVersionsAndUpdates 开头重置 3 个版本号文字颜色为默认灰色，仅检测到更新时才设为绿色
- **APK 更新通道标识** — 设置页"更新通道"标题改为"APK 更新通道"，并增加说明文字"仅适用于 APK 本体的更新检测"，避免误以为 Hermes Agent / WebUI 也能切换通道
