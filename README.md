...
│                                                       │
│   MainActivity ──→ proot (libproot.so)                │
│        │                    │                         │
│        │                    ▼                         │
│   ┌────┴──────────────────────────────────────────┐   │
│   │  Ubuntu 24.04 rootfs (app data, ~28MB)        │   │
│   │                                                │   │
│   │  apt → python3, git, build-essential          │   │
│   │       libffi, openssl...                      │   │
│   │  pip → hermes-agent                           │   │
│   │  npm → hermes-web-ui                          │   │
│   │                                                │   │
│   │  bin/python3  bin/hermes  bin/hermes-web-ui    │   │
│   └────────────────────────────────────────────────┘   │
└──────────────────────────────────────────────────────┘
```
...
- [OpenClaw Termux](https://github.com/mithun50/openclaw-termux) — 项目灵感来源，proot + Ubuntu rootfs 安卓方案
